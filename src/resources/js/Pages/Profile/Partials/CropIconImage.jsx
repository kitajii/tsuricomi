  ...
  return (
    <div>
      ...
      <div className="mt-3 w-[300px] h-[300px] flex items-center rounded-lg overflow-hidden bg-gray-300">
        {croppedImgSrc ? (
          <img src={croppedImgSrc} alt="Cropped" className="w-full object-contain bg-gray-300" />
        ) : (
          <div className="bg-gray-300 w-full h-full flex items-center justify-center text-white font-bold">アイコンが未登録です</div>
        )}
      </div>
      <CropperModal
        crop={crop}
